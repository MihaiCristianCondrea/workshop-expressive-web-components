...
`;var mt=function(t,s,e,i){for(var r,o=arguments.length,n=o<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(s,e,n):r(s,e))||n);return o>3&&n&&Object.defineProperty(s,e,n),n};let bt=class extends nt{constructor(){super(...arguments),this.variant="primary",this.size="medium",this.disabled=!1,this.loading=!1,this.hasIcon=!1,this.hasLabel=!1,this.contentObserver=new MutationObserver(()=>{this.syncSlottedState()})}connectedCallback(){super.connectedCallback(),this.contentObserver.observe(this,{attributeFilter:["slot"],attributes:!0,childList:!0,subtree:!0}),this.syncSlottedState()}disconnectedCallback(){this.contentObserver.disconnect(),super.disconnectedCallback()}render(){const t=this.disabled||this.loading;return this.toggleAttribute("icon-only",this.hasIcon&&!this.hasLabel),F`
    ...
    `}renderSpinner(){return F`<span class="spinner" aria-hidden="true"></span>`}syncSlottedState(){const t=null!==this.querySelector('[slot="icon"]'),s=Array.from(this.childNodes).some(t=>t.nodeType===Node.TEXT_NODE?Boolean(t.textContent?.trim()):t.nodeType===Node.ELEMENT_NODE&&"icon"!==t.getAttribute("slot"));this.hasIcon!==t&&(this.hasIcon=t),this.hasLabel!==s&&(this.hasLabel=s)}};bt.styles=ft,mt([ht({reflect:!0})],bt.prototype,"variant",void 0),mt([ht({reflect:!0})],bt.prototype,"size",void 0),mt([ht({type:Boolean,reflect:!0})],bt.prototype,"disabled",void 0),mt([ht({type:Boolean,reflect:!0})],bt.prototype,"loading",void 0),mt([ht({attribute:"aria-label"})],bt.prototype,"accessibleLabel",void 0),mt([pt()],bt.prototype,"hasIcon",void 0),mt([pt()],bt.prototype,"hasLabel",void 0),bt=mt([lt("ws-button")],bt);const vt=o`
  :host {
    font-family: var(
      --ws-font-family,
      'Google Sans Flex',
...
`;var gt=function(t,s,e,i){for(var r,o=arguments.length,n=o<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(s,e,n):r(s,e))||n);return o>3&&n&&Object.defineProperty(s,e,n),n};let xt=class extends nt{constructor(){super(...arguments),this.itemId="",this.title="",this.icon="",this.subtitle="",this.badge="",this.disabled=!1,this.expanded=!1,this.selected=!1,this.hasChildren=!1}connectedCallback(){super.connectedCallback(),this.updateTreeState()}render(){const t=this.getNestingLevel(),s=this.clampedProgress;return this.toggleAttribute("data-nested",t>0),this.toggleAttribute("data-has-children",this.hasChildren),this.style.setProperty("--ws-drawer-item-depth",String(t)),F`
    ...
    `}updated(t){t.has("selectedItemId")&&this.syncSelection()}};kt.styles=vt,yt([ht({attribute:"selected-item-id"})],kt.prototype,"selectedItemId",void 0),kt=yt([lt("ws-drawer")],kt);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Mt=function(t,s,e,i){for(var r,o=arguments.length,n=o<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(s,e,n):r(s,e))||n);return o>3&&n&&Object.defineProperty(s,e,n),n};let Gt=class extends nt{render(){return F`
      <div
        class="tabs"
        part="tabs"
        role="tablist"
    ...
    `}};Gt.styles=Et,Mt([ht({attribute:"aria-label"})],Gt.prototype,"accessibleLabel",void 0),Gt=Mt([lt("ws-tabs")],Gt);const It=o`
  :host {
    color: var(--ws-color-on-surface-variant, #64748b);
    display: inline-flex;
    font-family: var(
...
`;var Rt=function(t,s,e,i){for(var r,o=arguments.length,n=o<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(s,e,n):r(s,e))||n);return o>3&&n&&Object.defineProperty(s,e,n),n};let Tt=class extends nt{constructor(){super(...arguments),this.href="#",this.selected=!1,this.currentWhenSelected="page"}render(){return F`
      <a
        class="tab"
        part="tab"
        role="tab"
    ...
    `}};Tt.styles=It,Rt([ht()],Tt.prototype,"href",void 0),Rt([ht({type:Boolean,reflect:!0})],Tt.prototype,"selected",void 0),Rt([ht({attribute:"current-when-selected"})],Tt.prototype,"currentWhenSelected",void 0),Tt=Rt([lt("ws-tab")],Tt);const Bt=o`
  :host {
    color: var(
...
`;var Lt=function(t,s,e,i){for(var r,o=arguments.length,n=o<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(s,e,n):r(s,e))||n);return o>3&&n&&Object.defineProperty(s,e,n),n};let Nt=class extends nt{constructor(){super(...arguments),this.crumbs=[]}render(){return 0===this.crumbs.length?W:F`
    ...
    `}renderCrumb(t,s){const e=s===this.crumbs.length-1,i=t.label,r=e?F`<span class="crumb" part="crumb" aria-current="page"
          >${i}</span
