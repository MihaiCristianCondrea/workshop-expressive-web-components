...
`;var _t=function(t,s,i,e){for(var o,r=arguments.length,n=r<3?s:null===e?e=Object.getOwnPropertyDescriptor(s,i):e,a=t.length-1;a>=0;a--)(o=t[a])&&(n=(r<3?o(n):r>3?o(s,i,n):o(s,i))||n);return r>3&&n&&Object.defineProperty(s,i,n),n};let Et=class extends nt{constructor(){super(...arguments),this.markText="W",this.title="Workshop",this.subtitle="",this.size="48px",this.gradientColors=""}render(){const t={"--ws-brand-mark-size":this.size,...this.gradientColors?{"--ws-brand-mark-gradient":this.gradientValue}:{}};return G`
    ...
    `}renderDefaultMark(){return"W"!==this.markText?this.markText:G`
      <svg
        class="logo"
        viewBox="0 0 100 100"
        focusable="false"
    ...
    `}get gradientValue(){const t=this.gradientColors.split(",").map(t=>t.trim()).filter(Boolean);if(!(t.length<2))return`linear-gradient(135deg, ${t.join(", ")})`}};Et.styles=jt,_t([ht({attribute:"mark-text"})],Et.prototype,"markText",void 0),_t([ht()],Et.prototype,"title",void 0),_t([ht()],Et.prototype,"subtitle",void 0),_t([ht()],Et.prototype,"size",void 0),_t([ht({attribute:"gradient-colors"})],Et.prototype,"gradientColors",void 0),Et=_t([lt("ws-brand-mark")],Et);
